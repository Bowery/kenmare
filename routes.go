...
var Routes = []web.Route{
	...
	{"GET", "/applications/{id}", getApplicationByIDHandler},
	{"PUT", "/applications/{id}", updateApplicationByIDHandler},
	{"DELETE", "/applications/{id}", removeApplicationByIDHandler},
	{"PUT", "/applications/{id}/save", saveApplicationByIDHandler},
	{"GET", "/environments", searchEnvironmentsHandler},
	{"GET", "/environments/{id}", getEnvironmentByIDHandler},
	{"PUT", "/environments/{id}", updateEnvironmentByIDHandler},
	{"PUT", "/environments/{id}/share", shareEnvironmentByIDHandler},
	{"DELETE", "/environments/{id}/share", revokeAcccessToEnvByIDHandler},
	{"POST", "/events", createEventHandler},
	{"GET", "/auth/validate-keys", validateKeysHandler},
	{"GET", "/client/check", clientCheckHandler},
	{"GET", "/_/stats/instance-count", getInstanceCountHandler},
}
